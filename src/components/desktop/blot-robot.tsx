...
export function BlotRobot({ className = 'w-full' }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <ellipse cx="32" cy="59.5" rx="14" ry="2.6" fill="#7d8894" opacity="0.22" />
      ...
      <g className="blot-bob">
        ...
        <ellipse cx="26" cy="29" rx="7.5" ry="5.5" fill="#fff" opacity="0.75" />
        <path
        ...
        />
        {/* 가슴의 작은 동그라미 (심장 표시) */}
        <circle cx="39" cy="27.5" r="3.2" fill="none" stroke="#c9d1db" strokeWidth="0.9" />

        {/* 안테나 — blot만의 표시라 남겨 둡니다. */}
        <path d="M32 6.5V3.5" stroke="#c2cad5" strokeWidth="1.8" strokeLinecap="round" />
        <circle cx="32" cy="2.6" r="1.9" fill="#dfe5ec" />

        {/* 머리 */}
        <ellipse cx="32" cy="14.5" rx="11.5" ry="9.5" fill="url(#blot-head-g)" />
        <ellipse cx="28" cy="11" rx="4.5" ry="3.2" fill="#fff" opacity="0.8" />

        {/* 얼굴 — 눈 두 개와 웃는 입 */}
        <circle cx="27.4" cy="14.5" r="1.9" fill="#2f3438" />
        <circle cx="36.6" cy="14.5" r="1.9" fill="#2f3438" />
        <circle cx="26.8" cy="13.9" r="0.6" fill="#fff" opacity="0.85" />
        <circle cx="36" cy="13.9" r="0.6" fill="#fff" opacity="0.85" />
        <path
